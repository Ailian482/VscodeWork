...
# 2024-11-08
## 所有产品账单模板增加入住人部门/ 部门全路径 ，账单导出根据模板配置增加上述字段（待测试：）
...
-- 账单明细添加出差人部门名称，部门全称字段
call AddColumnUnlessExists('corp_credit_bill_payment', 'traveller_dept_names', 'varchar(500) comment "出行人部门名称"');
call AddColumnUnlessExists('corp_credit_bill_payment', 'traveller_dept_full_names', 'varchar(1000) comment "出行人部门全称"');

-- 帐单模板新增出差人部门名称字段
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptNames', '乘机人部门', 'Flight' FROM corp_credit_bill_field;
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptNames', '乘机人部门', 'IntFlight' FROM corp_credit_bill_field;
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptNames', '乘车人部门', 'Train' FROM corp_credit_bill_field;
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptNames', '入住人部门', 'Hotel' FROM corp_credit_bill_field;
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptNames', '入住人部门', 'IntHotel' FROM corp_credit_bill_field;
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptNames', '出差人部门', 'CommonOrder' FROM corp_credit_bill_field;

-- 帐单模板新增出差人部门全称字段
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptFullNames', '乘机人部门（全路径）', 'Flight' FROM corp_credit_bill_field;
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptFullNames', '乘机人部门（全路径）', 'IntFlight' FROM corp_credit_bill_field;
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptFullNames', '乘车人部门（全路径）', 'Train' FROM corp_credit_bill_field;
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptFullNames', '入住人部门（全路径）', 'Hotel' FROM corp_credit_bill_field;
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptFullNames', '入住人部门（全路径）', 'IntHotel' FROM corp_credit_bill_field;
INSERT INTO corp_credit_bill_field (id, field_code, field_header, field_type) SELECT MAX(id)+1,'travellerDeptFullNames', '出差人部门（全路径）', 'CommonOrder' FROM corp_credit_bill_field;
```
