...
王建军		440301197406185313工行
陈栩		440902198911220179工行
闫猛		411503199206104038工行
...
- 后端分支: tmc: pref-flightAttention, basic-resource-service: pref-attention
```
...
```
网店编单添加协议编码：目前是在创建订单，出票确认，订单详情，导出这几点添加协议编码。然后改签，退票订单上仅有字段为空，目前暂无赋值的场景。后续有空可以看一下这个
```
